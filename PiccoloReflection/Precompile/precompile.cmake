# 
set(PRECOMPILE_TOOLS_PATH "${REFLECTION_ROOT_DIR}/MetaParser/bin")
set(PICCOLO_PRECOMPILE_PARAMS_IN_PATH "${REFLECTION_ROOT_DIR}/precompile/precompile.json.in")
...
if (CMAKE_HOST_WIN32)
	...
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/${PARSER_TARGET}.exe)
    set(sys_include "*") 
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" )
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/${PARSER_TARGET})
...
COMMAND
    ${PRECOMPILE_PARSER} "${PICCOLO_PRECOMPILE_PARAMS_PATH}"  "${PARSER_INPUT}"  "${REFLECTION_ROOT_DIR}/ReflectionCore"  ${sys_include} "Piccolo" 0
### BUILDING ====================================================================================
COMMAND
